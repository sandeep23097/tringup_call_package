...
class CdrRecord extends Equatable {
  ...
  /// Host-app chat thread linked to this call. Populated by [TringupCallGetxController.fetchHistory].
  /// Not stored in the local SQLite DB — resolved at fetch time from the persisted chatId map.
  final String? chatId;
  ...
  CdrRecord copyWith({String? chatId}) => CdrRecord(
        callId: callId,
        direction: direction,
        status: status,
        callee: callee,

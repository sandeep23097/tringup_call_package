...
class ActiveCall with _$ActiveCall implements CallEntry {
  ...
  @override
  final List<ConferenceParticipant> conferenceParticipants;
  ...
  /// Group name for group calls. When non-null this is a group call and the
  /// name should be shown instead of the resolved contact name.
  @override
  final String? groupName;

  /// Host-app chat thread ID linked to this call.
  /// Set by the caller on outgoing calls and forwarded via the backend to all callees.
  @override
  final String? chatId;

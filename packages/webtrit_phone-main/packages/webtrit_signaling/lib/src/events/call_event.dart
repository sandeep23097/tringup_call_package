...
abstract class CallEvent extends LineEvent {
  ...
  static final Map<String, CallEvent Function(Map<String, dynamic>)> _callEventFromJsonDecoders = {
    ...
    CallInviteEvent.typeValue:     CallInviteEvent.fromJson,
    CallProceedingEvent.typeValue: CallProceedingEvent.fromJson,
    CallRingingEvent.typeValue:    CallRingingEvent.fromJson,
    CallAcceptedEvent.typeValue:   CallAcceptedEvent.fromJson,
    CallEndedEvent.typeValue:      CallEndedEvent.fromJson,
    ParticipantJoinedEvent.typeValue: ParticipantJoinedEvent.fromJson,
    ParticipantLeftEvent.typeValue:   ParticipantLeftEvent.fromJson,
    // ── Legacy events ────────────────────────────────────────────────────────
